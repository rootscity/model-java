...
public class Types {
  ...
  public static final String NAME_TYPE_TITLE = "_TITL";
  ...
  public static final String FACT_TYPE_AFIL = "AFIL";
  public static final String FACT_TYPE_AGE = "AGE";
  ...
  public static final String FACT_TYPE_EXCM = "EXCM";
  public static final String FACT_TYPE_FSFTID = "FSFTID"; // FamilySearch FamilyTree ID
  public static final String FACT_TYPE_FCOM = "FCOM";
  public static final String FACT_TYPE_FUN = "FUN";
  ...
  public static final String FACT_TYPE_MSTAT = "MSTAT";
  public static final String FACT_TYPE_MDCL = "MDCL";
  public static final String FACT_TYPE_MILT = "MILT";
  public static final String FACT_TYPE_MISN = "MISN";
  public static final String FACT_TYPE_MOVE = "MOVE";
  public static final String FACT_TYPE_NAMS = "NAMS";
  public static final String FACT_TYPE_NID = "NID";
  public static final String FACT_TYPE_NATI = "NATI";
  public static final String FACT_TYPE_NATU = "NATU";
  public static final String FACT_TYPE_NEWS = "NEWS";
  public static final String FACT_TYPE_NCHI = "NCHI";
  public static final String FACT_TYPE_OBIT = "OBIT";
  ...
  public static final String FACT_TYPE_RACE = "RACE";
  ...
  public static final String FACT_TYPE_STIL = "STIL";
  ...
  public static final String FACT_TYPE_SEPR = "SEPR";
  public static final String FACT_TYPE_CIVL = "CIVL";
  ...
  public static final String FACT_TYPE_MBON = "MBON";
  ...
  public static final String TOKEN_TYPE_MEDIAS = "media";
